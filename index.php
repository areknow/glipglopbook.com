...
<html lang="en">
  ...
  <body class="front">
    <ul id="slide-out" class="side-nav">
      <div class="side-menu-header">Glip Glop</div>
    ...
    <div class="navigation-bar">
      <div class="logo">
        <a href="#" class="button-collapse block" data-activates="slide-out"><i class="material-icons">menu</i></a>
        <div class="block glip">Glip Glop</div>
      </div>
      <div class="menu">
    ...
    <section id="about">
      <h1>How does Glip Glop work?</h1>
      <div class="row circle-row">
        <div class="col l4 m4 s12">
          <div id="btn-about1" class="about-circle search active-circle"><div class="inner">Search</div></div>
        </div>
        <div class="col l4 m4 s12">
          <div id="btn-about2" class="about-circle meetup"><div class="inner">Meet Up</div></div>
        </div>
        <div class="col l4 m4 s12">
          <div id="btn-about3" class="about-circle exchange"><div class="inner">Exchange</div></div>
        </div>
      </div>
    ...
    <section id="started">
      ...
      <div class="row started-row">
        <div class="col l6 m6 s12 first">
          ...
          <div><a class="waves-effect waves-light btn-flat">GO</a></div>
        </div>
        <div class="col l6 m6 s12 links">
          <p>Learn more about Glip Glop</p>
          <div>
            <a href="#!" class="waves-effect waves-light">
              <i class="material-icons prefix">search</i>Search for a book</a>
            <a href="#!" class="waves-effect waves-light">
